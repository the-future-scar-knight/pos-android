...
class RefundMathTest {
    ...
    fun fullReturn_refundsExactlyWhatWasPaid_plainSale() {
        ...
        val q = computeRefundTotal(returnedSubtotal = 100.0, saleSubtotal = 100.0, saleTotal = 100.0)
    ...
    fun fullReturn_refundsGrossTotal_withVat() {
        ...
        val q = computeRefundTotal(returnedSubtotal = 100.0, saleSubtotal = 100.0, saleTotal = 115.0)
    ...
    fun partialReturn_carriesVatShare() {
        ...
        val q = computeRefundTotal(returnedSubtotal = 50.0, saleSubtotal = 100.0, saleTotal = 115.0)
    ...
    fun partialReturn_carriesDiscountShare() {
        ...
        val q = computeRefundTotal(returnedSubtotal = 40.0, saleSubtotal = 100.0, saleTotal = 90.0)
    ...
    fun partialReturn_carriesDiscountAndVatTogether() {
        ...
        val q = computeRefundTotal(returnedSubtotal = 50.0, saleSubtotal = 200.0, saleTotal = 207.0)
    ...
    fun zeroSaleSubtotal_fallsBackToFaceValue_noDivideByZero() {
        ...
        val q = computeRefundTotal(returnedSubtotal = 30.0, saleSubtotal = 0.0, saleTotal = 0.0)
        assertEquals(1.0, q.effectiveRatio, eps)
    ...
    fun nothingReturned_isZero() {
        val q = computeRefundTotal(returnedSubtotal = 0.0, saleSubtotal = 100.0, saleTotal = 115.0)
        assertEquals(0.0, q.refundTotal, eps)
    }

    @Test
    fun negativeReturnedSubtotal_clampedToZero() {
        val q = computeRefundTotal(returnedSubtotal = -10.0, saleSubtotal = 100.0, saleTotal = 100.0)
